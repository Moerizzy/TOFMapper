...
[Download the trained model weights](https://myshare.uni-osnabrueck.de/d/2360edfcd80a453895d5/)

## Data Preprocessing

### Data Set

Get access to the dataset created for model training [here](https://zenodo.org/records/17468859).
